 ...
 * Endpoint Path: '/2018-11-05/field-level-encryption-profile/{Id}#DeleteFieldLevelEncryptionProfile'
 * Method: 'delete'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'DeleteFieldLevelEncryptionProfile',
        pathName: '/2018-11-05/field-level-encryption-profile/{Id}#DeleteFieldLevelEncryptionProfile',
        method: 'delete',
