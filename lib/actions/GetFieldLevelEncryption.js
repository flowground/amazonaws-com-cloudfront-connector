 ...
 * Endpoint Path: '/2018-11-05/field-level-encryption/{Id}#GetFieldLevelEncryption'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'GetFieldLevelEncryption',
        pathName: '/2018-11-05/field-level-encryption/{Id}#GetFieldLevelEncryption',
        method: 'get',
