 ...
 * Endpoint Path: '/2018-11-05/field-level-encryption/{Id}/config#GetFieldLevelEncryptionConfig'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'GetFieldLevelEncryptionConfig',
        pathName: '/2018-11-05/field-level-encryption/{Id}/config#GetFieldLevelEncryptionConfig',
        method: 'get',
